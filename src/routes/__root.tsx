...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "111 Fitness Club | Gym in Tirur, Kerala" },
      { name: "description", content: "111 Fitness Club — Premium gym in Tirur, Kerala. 4.7★ rated. Professional training, modern equipment, flexible memberships." },
      { name: "theme-color", content: "#0A0A0A" },
      { property: "og:title", content: "111 Fitness Club | Gym in Tirur, Kerala" },
